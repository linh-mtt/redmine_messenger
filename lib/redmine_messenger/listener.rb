...
class MessengerListener < Redmine::Hook::Listener
	def redmine_messenger_issues_new_after_save(context={})
		issue = context[:issue]
		...
		attachment[:fields] << {
			...
			:short => true
		} if Setting.plugin_redmine_messenger['display_watchers'] == 'yes'

		speak msg, channel, attachment, url
	end

	def redmine_messenger_issues_edit_after_save(context={})
		issue = context[:issue]
		...
		return unless channel and url and Setting.plugin_redmine_messenger['post_updates'] == '1'
		return if issue.is_private?
	...
	def controller_wiki_edit_after_save(context = { })
		return unless Setting.plugin_redmine_messenger['post_wiki_updates'] == '1'
	...
	def speak(msg, channel, attachment=nil, url=nil)
		url = Setting.plugin_redmine_messenger['messenger_url'] if not url
		username = Setting.plugin_redmine_messenger['username']
		icon = Setting.plugin_redmine_messenger['icon']
...
private
	...
	def url_for_project(proj)
		...
		return [
			...
			Setting.plugin_redmine_messenger['messenger_url'],
		].find{|v| v.present?}
	end
	...
	def channel_for_project(proj)
		...
		val = [
			...
			Setting.plugin_redmine_messenger['channel'],
		].find{|v| v.present?}
